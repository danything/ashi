...
<div class="stack" style="--gap: 1.25rem">
	<div class="head">
		<hgroup>
			<h1>弾かれたこと</h1>
			<p>
				権限・鍵・上限が足りずに進めなかったこと。初めて起きたときに通知し、同じ先がうまくいったら自動で片づく。
			</p>
		</hgroup>
		<a class="button outline small" href="https://github.com/danything/ashi/blob/main/docs/permissions.md" rel="noopener noreferrer" target="_blank">
			権限の付け方
		</a>
	</div>
